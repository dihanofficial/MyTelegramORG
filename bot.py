...
def start(update, context):
    ...
    update.message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Updates', url='https://t.me/dihanofficial'),
                    InlineKeyboardButton('Support', url='https://t.me/dihan_official')
              ],[
                    InlineKeyboardButton('READEME', url='https://t.me/dihanofficial')
               ]
            ]
        )
    )
