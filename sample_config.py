...
class Config(object):
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "Dihan Official")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "Dihanofficial")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/dihanofficial")
    ...
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Please Subscribe ❤️ @dihanofficial")
